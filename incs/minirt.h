...
/*   Updated: 2026/01/16 17:10:50 by mlouis           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			check_hit_light(t_scene scene, t_obj *obj, double t, t_vect3 n);
...
t_color_sum	add_light(t_color_sum sum, t_scene scene, t_obj obj, t_vect3 n);
t_color_sum	add_specular(t_color_sum sum, t_scene scene, t_obj obj, t_vect3 n);
