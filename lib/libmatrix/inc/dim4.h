...
/*   Updated: 2025/11/03 22:51:39 by cviel            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_mat4	mat4_mult_nb(t_mat4 m, double lambda);
t_mat4	mat4_mult(t_mat4 m1, t_mat4 m2);
t_mat4	mat4_trans(t_mat4 m);
double	scalar4(t_vect4 v1, t_vect4 v2);
t_vect4	vect4_add(t_vect4 v1, t_vect4 v2);
t_vect4	vect4_mult_nb(t_vect4 v, double lambda);
